...
public class Player implements Serializable {
    public static int WIDTH = Game.scale(50);
    public static final int HEIGHT = Game.scale(50);
    ...
    private int explosionRange = Game.scale(100);
    ...
    public Rectangle getCollider() {
        return new Rectangle(x, y, Game.scale(45), Game.scale(45));
    }
    ...
    public void upgradeSpeed() {
        ...
        speed = Game.scale(5 + (speedBoostLevel * 2));
    }

    public void upgradeExplosion() {
        if (explosionRangeLevel < 3) explosionRangeLevel++;
        explosionRange = Game.scale(100 + (explosionRangeLevel * 50));
    }
